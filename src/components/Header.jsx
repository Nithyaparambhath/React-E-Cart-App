      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <Nav.Link className='btn border rounded'><Link className='d-flex align-items-center' to={'/wishlist'} style={{color:'#ffffff',textDecoration:'none',fontWeight:'bold'}}><i class="fa-solid fa-heart text-danger me-2"></i> Wishlist <Badge className='ms-2 rounded' bg='light'>10</Badge></Link></Nav.Link>
